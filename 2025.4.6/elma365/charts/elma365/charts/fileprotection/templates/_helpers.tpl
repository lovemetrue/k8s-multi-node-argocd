...
*/}}
{{- define "fileprotection.fullname" -}}
...
Common labels
*/}}
{{- define "fileprotection.labels" -}}
helm.sh/chart: {{ include "fileprotection.chart" . }}
{{- range $k,$v := .Values.global.labels }}
{{ $k }}: {{ $v | quote }}
{{- end }}
{{ include "fileprotection.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "fileprotection.selectorLabels" -}}
app: {{ include "fileprotection.name" . }}
tier: elma365
app.kubernetes.io/name: {{ include "fileprotection.name" . }}
...
*/}}
{{- define "fileprotection.featureFlags" -}}
...
Usage:
{{ include "fileprotection.supportsIngressClassname" . }}
*/}}
{{- define "fileprotection.supportsIngressClassname" -}}
